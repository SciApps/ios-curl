#
#  Be sure to run `pod spec lint curl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "http://192.168.10.2/stash/scm/~robert.balint/curl-bin.git", :tag => "7.48.0" }
  ...
  s.preserve_paths = 'lib/libcurl-ios.a'
  # s.library = 'curl-ios'
